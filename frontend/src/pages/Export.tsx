        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-2">
              ...
              <span>You are exporting a commerce-ready product dataset</span>
            </div>
            <h2 className="text-2xl font-bold text-white tracking-tight">
              Export Commerce-Ready Product Data
            </h2>
            <p className="text-xs text-slate-400 mt-1">
              Download your structured, normalized, and validated product intelligence in your preferred format.
            </p>
          </div>

          <div className="flex items-center gap-3">
            <div className="px-4 py-2 rounded-2xl bg-slate-900/80 border border-slate-800 text-center">
              <span className="text-[10px] text-slate-400 font-semibold uppercase block">Catalog Size</span>
              <span className="text-sm font-bold text-white font-mono">{previewData?.total_products || '1,000'} Products</span>
            </div>
            <div className="px-4 py-2 rounded-2xl bg-slate-900/80 border border-slate-800 text-center">
              <span className="text-[10px] text-slate-400 font-semibold uppercase block">Delivery Schema</span>
              <span className="text-sm font-bold text-cyan-400 font-mono">252 Columns</span>
            </div>
            <div className="px-4 py-2 rounded-2xl bg-emerald-950/20 border border-emerald-800/40 text-center">
              <span className="text-[10px] text-emerald-400 font-semibold uppercase block">Schema Status</span>
              <span className="text-sm font-bold text-emerald-300">Verified 100%</span>
            </div>
          </div>
        </div>
